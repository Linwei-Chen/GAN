...
from src.pix2pixHD.criterion import get_GANLoss, VGGLoss, DiscriminatorFeaturesLoss
...
if __name__ == '__main__':
    ...
    for epoch in range(epoch_now, args.epochs):
        ...
        for step, sample in enumerate(data_loader):
            ...
            data_loader.write(f'Dloss:{D_loss:.6f} | Gloss:{G_loss:.6f}'
            ...
            sw.add_image('img/real', imgs[0], total_steps)
            sw.add_image('img/fake', fakes[0], total_steps)
            # sw.add_images('fakes', fakes, total_steps)
            sw.add_image('img/encode_feature', encode_features[0], total_steps)
            sw.close()
            # sw.add_images('encode_features', encode_features, total_steps)
